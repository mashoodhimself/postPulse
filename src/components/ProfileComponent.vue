                            ...
                            <div class="tab-content pt-2">
                                ...
                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                    ...
                                    <form>
                                        ...
                                        <div class="row mb-3">
                                            <label for="c_password" class="col-md-4 col-lg-3 col-form-label">Conf Password</label>
                                            <div class="col-md-8 col-lg-9">
                                                <input name="password" type="password" class="form-control" id="c_password"
                                                    >
                                            </div>
                                        </div>

                                        <div class="row mb-3">
                                            <label for="profile_photo" class="col-md-4 col-lg-3 col-form-label">Upload Photo</label>
                                            <div class="col-md-8 col-lg-9">
